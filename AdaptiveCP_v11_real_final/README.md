...
### 7.3 주요 지표 상세 (M = 16 / 64 / 256)

각 지표는 30 스텝 평균값이며, `charts/M=*/12_param_table.png`(파라미터 비교표)에서 직접 산출된 값이다.

**M = 16**

| 지표 | No CP | Theoretical | Fixed CP | Adaptive (DQN) | Δ vs Fixed |
|---|---|---|---|---|---|
| σ_DS mean (ns) | — | 29.15 | 29.15 | 29.15 | — |
| SNR mean (dB) | — | 7.38 | 7.38 | 7.38 | — |
| CP mean (ns) | 0 | 87.44 | 75.00 | 42.54 | −32.46 ns |
| CP / σ_DS mean | 0 | 3.00 | 2.57 | 1.59 | −0.981 |
| SE mean (bps/Hz) | 1.3636 | 0.3583 | 0.3130 | 0.6562 | +109.6% |
| SE Normal (bps/Hz) | 1.3814 | 0.4144 | 0.3250 | 0.7940 | +144.3% |
| SE NLOS (bps/Hz) | 1.3220 | 0.2272 | 0.2850 | 0.3347 | +17.4% |
| SINR mean (dB) | −0.83 | 3.83 | 4.04 | 1.73 | −2.31 dB |
| BER mean | 9.95e-02 | 1.75e-02 | 2.23e-02 | 4.49e-02 | ×2.0 worse |
| Power Eff. mean (%) | 100.0 | 12.61 | 11.76 | 22.71 | +10.94 pp |
...
| 지표 | No CP | Theoretical | Fixed CP | Adaptive (DQN) | Δ vs Fixed |
|---|---|---|---|---|---|
| σ_DS mean (ns) | — | 27.22 | 27.22 | 27.22 | — |
| SNR mean (dB) | — | 7.59 | 7.59 | 7.59 | — |
| CP mean (ns) | 0 | 81.66 | 75.00 | 34.84 | −40.16 ns |
| CP / σ_DS mean | 0 | 3.00 | 2.76 | 1.48 | −1.280 |
| SE mean (bps/Hz) | 1.3904 | 0.4664 | 0.3272 | 0.7599 | +132.3% |
| SE Normal (bps/Hz) | 1.4143 | 0.5569 | 0.3328 | 0.8856 | +166.1% |
| SE NLOS (bps/Hz) | 1.3348 | 0.2551 | 0.3141 | 0.4665 | +48.5% |
| SINR mean (dB) | −0.79 | 3.04 | 3.66 | 1.20 | −2.45 dB |
| BER mean | 9.83e-02 | 2.41e-02 | 2.40e-02 | 5.32e-02 | ×2.2 worse |
| Power Eff. mean (%) | 100.0 | 15.43 | 11.76 | 25.72 | +13.96 pp |
| ISI Violations | 30/30 | 0 | 0 | 0/30 | — |
